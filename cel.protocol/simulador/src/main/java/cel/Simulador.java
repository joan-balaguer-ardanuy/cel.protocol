		...
		synchronized (this) {
			...
			for (Anyell<String, Coordenada> anyell : coordenades) {
				...
				case XX:
					...
					coordenada.setAngleX(coordenada.getAngleX() + PI / coordenada.getX2() % 50);
					break;
				case XY:
					rotateY(coordenada.getAngleY());
					coordenada.setAngleY(coordenada.getAngleY() + PI / coordenada.getY2() % 50);
					break;
				default:
					rotateX(coordenada.getAngleX());
					coordenada.setAngleX(coordenada.getAngleX() + PI / coordenada.getX2() % 50);
					...
					coordenada.setAngleZ(coordenada.getAngleZ() + PI / coordenada.getZ2() % 50);
					break;
				}
				translate(coordenada.initialX % 400, coordenada.initialY % 400, -coordenada.initialZ % 400);
				...
				sphere(coordenada.getTotal() % 40 + 100);
			}
		}
	}
